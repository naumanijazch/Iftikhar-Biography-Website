      ...
      <Container>
        <Row style={{ justifyContent: "center", padding: "10px" }}>
            ...
            My country of birth is Pakistan and I worked there as a journalist for a wire service
             - <a href="https://www.app.com.pk" target="_blank" rel="noreferrer" style={{ 
              textDecoration: "underline", color: "inherit" }}>Associated Press of Pakistan (APP)</a>. 
             ...
             I have post graduate degrees in International Studies from the <a href = "https://www.sydney.edu.au/" 
             target = "_blank" rel="noreferrer" style={{ textDecoration: "underline", color: "inherit" }}
